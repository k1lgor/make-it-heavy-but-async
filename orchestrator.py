#!/usr/bin/env python3
"""
🔄 ORIGINAL SYNC ORCHESTRATOR IMPLEMENTATION
Part of Make It Heavy - Original Implementation

This is the original synchronous multi-agent orchestrator implementation,
maintained for comparison with the async performance edition.

For better performance, use: from orchestrator_async import AsyncTaskOrchestrator
"""
...
class TaskOrchestrator:
    ...
    def _aggregate_consensus(
        self, responses: List[str], _results: List[Dict[str, Any]]
    ) -> str:
        """
